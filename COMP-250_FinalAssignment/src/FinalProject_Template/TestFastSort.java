...
public class TestFastSort extends StressTest {
    ...
    Boolean tester(){
        try {
            ...
            //ArrayList<String> keyList = MyHashTable.slowSort(tweetTable);
            
            //ArrayList<String> slowSortKeyList = MyHashTable.slowSort(tweetTable);
            /*if (keyList.equals(slowSortKeyList)) {
            	this.out.println("GOOD SORTING");
            	
            }else{
            	this.out.println("BAD SORTING");
            }*/
